using Personal_Librarian.Client.Commands.Base;

namespace Personal_Librarian.Client.Commands
{
    public class LambdaCommand : RelayCommand
    {
    ...
    public class LambdaCommand<T> : RelayCommand
    {
        private readonly Delegate? _Execute;
        private readonly Delegate? _CanExecute;
